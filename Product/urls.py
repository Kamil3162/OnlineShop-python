...
urlpatterns = [
    ...
    path('all/product/<str:category>/', views.Product_details.as_view(), name='product_view'),
    path('all/product/<str:category>/<int:id_prod>/', views.Product_details.as_view(), name='product_view'),
